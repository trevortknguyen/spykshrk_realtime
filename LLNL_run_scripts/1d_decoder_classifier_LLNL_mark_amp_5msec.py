...
def main(path_base, rat_name, day, epoch, shift_amt, spike_amp_min, path_out):
    print(datetime.now())
    ...
    print('Spike minimum amp: ',spike_amp_min)
    ...
    marks = trodes2SS.threshold_marks(marks, maxthresh=2000,minthresh=spike_amp_min)
    ...
    posterior_file_name = os.path.join(path_out,  rat_name + '_' + str(day) + '_' + str(epoch) + '_spike_min_' + str(spike_amp_min) + '_shuffle_' + str(shift_amount) + '_posteriors_functionalized.nc')
    ...
    position_file_name = os.path.join(path_out, rat_name + '_' + str(day) + '_' + str(epoch) + '_spike_min_' + str(spike_amp_min) + '_shuffle_' + str(shift_amount) + '_linearposition_functionalized.nc')
    ...
    posterior_file_name_hdf5 = os.path.join(path_out,  rat_name + '_' + str(day) + '_' + str(epoch) + '_spike_min_' + str(spike_amp_min) + '_shuffle_' + str(shift_amount) + '_posteriors_functionalized.h5')
...
if __name__ == '__main__':
    ...
    parser.add_argument('-m', action='store', dest='spike_amp_min', type=int, help='Minimum spike amplitude')
    parser.add_argument('-o', action='store', dest='path_out', help='Path to output')
    results = parser.parse_args()

main(results.path_base, results.rat_name, results.day, results.epoch, results.shift_amt, results.spike_amp_min, results.path_out)
